    ...
    <div>
      <header>
        <nav
          ...
          className="group fixed z-20 w-full border-b border-dashed bg-white/95 backdrop-blur md:relative dark:bg-zinc-950/50 lg:dark:bg-transparent"
        >
              ...
              <div className="[transform:rotateX(20deg)]">
                <div className="relative skew-x-[.36rad] lg:h-[44rem]">
                  <Image
                    ...
                    src="https://unsplash.com/photos/8BSAhVK9-Ys/download?force=true&w=2880"
                    alt="A small stand on a beach with chairs and a table"
                    width={2880}
                    height={2074}
                  />
                  <Image
                    className="relative z-[2] hidden rounded-[--radius] border dark:block"
                    src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=2880&q=80"
                    alt="Dark coding environment with monitor glow"
                    width={2880}
                    height={2074}
                  />
                </div>
          ...
          <div className="m-auto max-w-5xl px-6">
            ...
            <div className="mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
              {partnerIcons.map(({ name, Icon }) => (
                <div
                  key={name}
                  className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-white/70 text-text-secondary"
                  aria-label={`${name} partner icon`}
                  title={name}
                >
